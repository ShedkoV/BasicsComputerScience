...
"""
Программа выбора студента для работы над задачей
"""
import random


students = {
    1: 'Василевский Александр Витальевич',
    2: 'Городенская Виктория Александровна',
    3: 'Макаревич Вадим Сергеевич',
    4: 'Маркин Дмитрий Владимирович',
    5: 'Николаева Мария Александровна',
    6: 'Новик Ольга Андреевна',
    7: 'Терехова Ольга Дмитриевна',
    8: 'Трифонов Сергей Дмитриевич',
}

rnd_student = random.randint(1, len(students))
print('Очень хочет ответить', students[rnd_student])
